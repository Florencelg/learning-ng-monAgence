...
export class AdminPropertiesComponent implements OnInit {
  ...
  onSubmitPropertiesForm() {
    ...
    // Pour method reactive sans la createProperties
    // console.log(this.propertiesForm.value);
  }
  // Méthod Template:
  // onSubmitPropertiesForm(form: NgForm) {
  //   console.log(form.value);
  //   // si on veut seulement récupérer juste le titre:
  //   // const title = form.value['title'];
  //   // console.log(title);
  // }

  // Pour purger le formulaire:
  resetForm() {
    this.editMode = false;
  ...
  onDeleteProperty(index) {
    ...
    // Méthode si on utilise pas de modal de suppression:
  ...
  onConfirmDeleteProperty() {
    ...
    // if (
    //   this.properties[this.indexToRemove].photo &&
    //   this.properties[this.indexToRemove].photo !== ''
    // ) {
    //   this.propertiesService.removeFile(
    //     this.properties[this.indexToRemove].photo
    //   );
    // }
    this.properties[this.indexToRemove].photos.forEach((photo) => {
  ...
  onEditProperty(property: Property) {
    ...
    this.propertiesForm
      .get('description')
      .setValue(property.description ? property.description : '');
